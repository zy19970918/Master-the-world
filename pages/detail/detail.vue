			...
			<view class="content_bar">
				...
				<view class="main">
					<view class="main_left">
						...
						<view class="">班&ensp;&ensp;&ensp;&ensp;次:<text v-if="detaileInfo.workType==0">两班倒</text> <text v-if="detaileInfo.workTypeDay==1">长白班</text></view>
						<!-- <view class="">食宿费用:<text>500元/月</text></view> -->
						<view class="">工期要求:<text v-if="detaileInfo.workRequire==1">短期工</text><text v-if="detaileInfo.workRequireLong==0">长期工</text></view>
						<view class="">少数名族:<text>可接受</text></view>
						<view class="">学&ensp;生&ensp;工:<text v-if="detaileInfo.studentWorker==1">可接受</text><text v-if="detaileInfo.studentNotWorker==1">不接受</text></view>
					</view>
					<view class="main_right">
						<view class="" v-if="detaileInfo.ageOne==1&&detaileInfo.ageTwo==1&&detaileInfo.ageThree==1">年龄要求:<text>不限</text></view>
						<view class="" v-if="detaileInfo.ageOne==1&&detaileInfo.ageTwo==0&&detaileInfo.ageThree==0">年龄要求:<text>18-35岁</text></view>
						<view class="" v-if="detaileInfo.ageOne==0&&detaileInfo.ageTwo==0&&detaileInfo.ageThree==0">年龄要求:<text>35-50岁</text></view>
						<view class="" v-if="detaileInfo.ageOne==0&&detaileInfo.ageTwo==0&&detaileInfo.ageThree==1">年龄要求:<text>50岁以上</text></view>
						<view class="" v-if="detaileInfo.ageOne==1&&detaileInfo.ageTwo==1&&detaileInfo.ageThree==0">年龄要求:<text>18-50岁</text></view>
						<view class="" v-if="detaileInfo.ageOne==1&&detaileInfo.ageTwo==0&&detaileInfo.ageThree==1">年龄要求:<text>18-35岁&ensp;&ensp;50岁以上</text></view>
						<view class="" v-if="detaileInfo.ageOne==0&&detaileInfo.ageTwo==1&&detaileInfo.ageThree==1">年龄要求:<text>35岁以上</text></view>
						<view class="">文化程度:<text>{{detaileInfo.agriculture}}</text></view>
						<!-- <view class="">包&ensp;食&ensp;宿:<text>外宿食宿</text></view> -->
						<view class="">夫&ensp;妻&ensp;房:<text v-if="detaileInfo.spouseHouse==1">无</text><text v-if="detaileInfo.spouseHouseHusband==1">有</text></view>
					</view>
				</view>
				...
				<swiper class="swiper" :indicator-dots="false" acceleration display-multiple-items="2" :autoplay="true" :interval="1000"
				 circular :duration="8000">
					<swiper-item class="swiper_item" v-for="item in detaileInfo.imgAddrs" :key="index">
